    ...
    : IRequestHandler<GetQuestDetailsQuery, QuestCaseDetailDto?>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new QuestCaseDetailDto
        {
            ...
            VictimAge = quest.MurderCase.VictimAge,
            VictimJob = quest.MurderCase.VictimJob,
            VictimLifeSituation = quest.MurderCase.VictimLifeSituation,
            VictimImg = quest.MurderCase.VictimImg,
            CrimeSceneImg = quest.MurderCase.CrimeSceneImg,
            CrimeSceneImgText = quest.MurderCase.CrimeSceneImgText,
            ClueImg = quest.MurderCase.ClueImg,
            ClueImgText = quest.MurderCase.ClueImgText,
            SecondClueImg = quest.MurderCase.SecondClueImg,
            SecondClueImgText = quest.MurderCase.SecondClueImgText,
